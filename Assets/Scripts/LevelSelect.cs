...
public class LevelSelect : MonoBehaviour
{
    ...
    public void ShowLevelDetails(string level)
    {
        ...
        switch (level)
        {
            ...
            case "Level3":
                {
                    levelDetails_name.GetComponent<Text>().text = "Level 3 Locked";
                    levelDetails_stats.GetComponent<Text>().text = "Coming Soon";
            ...
            case "Level4":
                {
                    levelDetails_name.GetComponent<Text>().text = "Level 4 Locked";
                    levelDetails_stats.GetComponent<Text>().text = "Coming Soon";
            ...
            case "Level5":
                {
                    levelDetails_name.GetComponent<Text>().text = "Level 5 Locked";
                    levelDetails_stats.GetComponent<Text>().text = "Coming Soon";

...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        follow = GameObject.Find("Player").GetComponent<PlayerController>();
    ...
    void Update()
    {
        follow = GameObject.Find("Player Controller").GetComponent<PlayerController>();
        followXform = GameObject.Find("Player Controller").transform;
    }

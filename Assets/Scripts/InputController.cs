...
public class InputController : MonoBehaviour {
	...
	public int joystickID = -1; // used to keep track of which finger is controlling the joystick
	public int slideID = -1; // used to keep track of which finger is doing the swipe
	public Vector2 joystickPosition; // used for a moveable joystick
	public Vector2 slideStartPosition; // used for mapping a swipe
	...
	public bool start; // used to set time the start of a swipe
	public float oWidth = 0.0f; // used to divide the screen to figure out 
	public float oHeight = 0.0f; // used to find the width
